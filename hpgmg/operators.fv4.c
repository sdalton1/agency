...
int stencil_get_radius() {
    return(2);   // stencil reaches out 2 cells
}
int stencil_get_shape() {
    return(STENCIL_SHAPE_NO_CORNERS);   // needs faces and edges, but not corners
}
#else
int stencil_get_radius() {
    return(2);   // stencil reaches out 2 cells
...
int stencil_get_shape() {
    return(STENCIL_SHAPE_STAR);   // needs just faces
}
#endif
//------------------------------------------------------------------------------------------------------------------------------
...
void interpolation_vcycle(level_type * level_f, int id_f, double prescale_f, level_type *level_c, int id_c) {
    interpolation_v2(level_f,id_f,prescale_f,level_c,id_c);
}
void interpolation_fcycle(level_type * level_f, int id_f, double prescale_f, level_type *level_c, int id_c) {
    interpolation_v4(level_f,id_f,prescale_f,level_c,id_c);
}
//------------------------------------------------------------------------------------------------------------------------------
